...
document.querySelector("#start-game").addEventListener("click", function(){
    const player1 = new Player(document.querySelector("#p1-color").value,1);
    const player2 = new Player(document.querySelector("#p2-color").value,2);
    document.querySelector("div #board").innerHTML = "";
    new Game(undefined, undefined, player1, player2);
})